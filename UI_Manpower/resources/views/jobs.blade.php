...
<body>
  ...
  <div class="relative w-full h-screen">
    <img src="https://www.thebalancemoney.com/thmb/20qwODYCpMVUdRQSVrqw1nuMy-8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/looking-for-a-job--850239784-5c71f68946e0fb0001436234.jpg" alt="Background Image" class="w-full h-full object-cover">
  ...
  <div class="flex h-screen">
    ...
    <div class="bg-gray-800 text-white w-48 flex-shrink-0">
        <div class="p-4">
            <a href="#" onclick="showJobs(['Steelmen', 'Plate Welders', 'Pipelayers', 'Electricians', 'Air Conditioning Technician', 'Aluminum and Glass Technicians', 'Pipe Fitters', 'Plumbers', 'Fire Protection Technicians', 'Carpenters', 'Gypsum Board Installers', 'Decorative Technicians', 'Plasterers', 'Masons', 'Bricklayers', 'Painters', 'Scaffolders'])" class="block py-2 px-4 rounded hover:bg-gray-700">Construction</a>
            <a href="#" onclick="showJobs(['Special Education', 'Early Childhood Education', 'Pre-School', 'Speech and Language', 'English Language', 'Physical Education', 'Elementary Education', 'Intermediate Education', 'College Professors', 'Special Tutors'])" class="block py-2 px-4 rounded hover:bg-gray-700">Education</a>
            <a href="#" onclick="showJobs(['Chef', 'Sous Chef', 'Waiters', 'Chamber Maids', 'Baristas', 'Receptionists', 'Front Desk Officers', 'Security Guards', 'Bellboys', 'Busboys', 'Kitchen Helpers'])" class="block py-2 px-4 rounded hover:bg-gray-700">Hospitality</a>
            <a href="#" onclick="showJobs(['Web Design', 'Data Science and Analytics', 'Cybersecurity', 'Artificial Intelligence and Machine Learning', 'Network and Systems Administration', 'Mobile Application Development', 'Technical Writing', 'Digital Marketing and E-Commerce', 'Cloud Computing'])" class="block py-2 px-4 rounded hover:bg-gray-700">Information Technology</a>
            <a href="#" onclick="showJobs(['Garments- Sewers, Cutters', 'Semi-Conductor-Assemblers', 'Food- Packers, Food Technichians', 'Automotive- Assemblers, Painters, Mechanics', 'Heavy Machineries- Mechanical Technicians', 'Specialized Machine Operators'])" class="block py-2 px-4 rounded hover:bg-gray-700">Manufacturing</a>
            <a href="#" onclick="showJobs(['NURSES with specialities in;', 'Emergency and Trauma', 'Critical Care', 'Oncology', 'Geriatrics', 'Pediatrics', 'Pre-operational Care', 'Cardiac', 'Dialysis', 'Neo-natal', 'Acute Care', 'Anesthetics', 'Other Medical Fields', 'Physical Therapists', 'Radiology Technicians', 'Bioinformatics Technicians', 'Biotechnologists', 'Biochemists', 'Speech Pathologists', 'Dental Technicians'])" class="block py-2 px-4 rounded hover:bg-gray-700">Medical and Healthcare</a>
            <a href="#" onclick="showJobs(['Aestheticians', 'Massage Therapist', 'Hair Dressers', 'Make-Up Artists', 'Nail Technician'])" class="block py-2 px-4 rounded hover:bg-gray-700">Personal Beauty and Wellness</a>
            <a href="#" onclick="showJobs(['Sales Specialist', 'Cashiers', 'Storekeepers', 'Stock and Inventory Personnel', 'Fashion Consultants', 'Personal Shoppers', 'Customer Service Specialists'])" class="block py-2 px-4 rounded hover:bg-gray-700">Retail</a>
        </div>
    </div>
