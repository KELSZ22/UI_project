...
<div class="flex flex-1 bg-gray-50">
            ...
            <div class="flex flex-col flex-1 px-3 mt-6">
                <div class="space-y-4">
                    <nav class="flex-1 space-y-2">
                        <a href="/DataManagement" title="" class="flex items-center px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 bg-indigo-600 rounded-lg group">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 mr-4 text-white">
    ...
    <h2 class="text-2xl font-bold mb-4">Worker's Profile</h2>
    <table id="Workers" class="table-auto w-max">
        <thead>
            <tr>
